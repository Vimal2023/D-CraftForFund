...
import image2 from "../../../assets/images/bg3.jpg";
...
const Hero = () => {
  ...
  const changeImage = [image1, image2];
      ...
      <div className="contain flex flex-col items-start justify-center h-full relative z-10">
        <div className="flex flex-col items-start justify-start gap-5 w-full">
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-semibold leading-[120%]">
            Discover the Efficient <br /><i className="font-light">fundraiser/Lender</i>
          </h2>
          <div
          ...
          >
            ...
            <button
              ...
              type="submit"
              className="bg-cyan-500 h-full lg:w-[150px] outline-none absolute top-16 lg:relative lg:top-0 rounded-md lg:rounded-[0] lg:rounded-tr-md lg:rounded-br-md w-full"
            >
              Explore
            </button>
          </div>
