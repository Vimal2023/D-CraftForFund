        ...
        <div className="flex flex-col items-start justify-between w-full gap-9">
          ...
          <div className="w-full grid grid-cols-3 md:grid-cols-5 justify-center items-center gap-7 mt-6">
            {marketsData.map((item, i) => (
              ...
              >
                <div className="w-12 h-12 relative after:content-[''] after:absolute after:-bottom-2 after:w-full after:h-[2px] after:bg-[#c5c6c9] group-hover:after:bg-cyan-400 group-hover:after:w-20 group-hover:after:translate-x-[-20%] after:transition-all after:duration-300">
