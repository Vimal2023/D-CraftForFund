        ...
        <div className="w-full lg:w-[75%] flex items-center flex-col sm:flex-row justify-center py-10 mx-auto">
          ...
          >
            <div className="flex items-start justify-start flex-col gap-4 w-full sm:flex-1">
              ...
              <button
                type="submit"
                className="w-full bg-cyan-400/80 hover:bg-cyan-500 cursor-pointer outline-none text-white rounded py-3 transition-all duration-300 mt-4 hidden sm:block"
              >
                {loading ? (
              ...
              <div className="w-full mt-8">
                <label className="flex items-center justify-start w-full relative gap-4">
                  <span className="text-[#5D6771] text-[15px] leading-5 font-medium flex items-center justify-center select-none">
                    Activate the Fundraiser account
                  </span>
            ...
            <button
              type="submit"
              className="w-full bg-cyan-400/80 hover:bg-primary cursor-pointer outline-none text-white rounded py-3 transition-all duration-300 mt-4 sm:hidden"
            >
              {loading ? (
                <div className="flex items-center justify-center">
                  <img src={loader} alt="/" className="w-[40px]" />
