      ...
      <div className="contain flex justify-center items-center">
        ...
        >
          ...
          >
            ...
            <button
              type="submit"
              className="mt-5 bg-cyan-400/80 hover:bg-cyan-500 w-full rounded-md text-white py-2 text-base font-semibold"
            >
              {loading ? (
          ...
          >
            Not a member yet?
            <Link to="/join" className="text-cyan-400">
              Join now
            </Link>
          </div>
        </motion.div>
