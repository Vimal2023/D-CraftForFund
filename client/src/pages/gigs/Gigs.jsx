    ...
    <main className="py-40">
      <div className="contain">
        <div className="flex items-start justify-start flex-col gap-4">
          ...
          <h2 className="text-3xl font-bold">Tech Zone Projects</h2>
          <p className="text-base font-medium">
            Find a Project/Cause to Lend or FundRaise
          </p>
          ...
          <div className="flex md:items-center items-start justify-start gap-2 flex-col md:flex-row">
              <p className="text-base font-normal text-gray-500">Amount:</p>
